  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-50">
        <div className="h-full w-full px-4 md:px-12 pt-24 pb-16 flex items-start">
          <div
            className={`max-w-xl mt-4 md:mt-10 ${
          ...
          >
            ...
            <motion.div
              ...
              className="space-y-6 backdrop-blur-xl bg-white/10 rounded-3xl px-6 py-7 md:px-10 md:py-8 shadow-2xl border border-white/20"
            >
              <motion.h1
              ...
              >
                <Link href={`/${locale}/donate`}>
                  <Button
                    size="lg"
                    className="text-lg px-10 py-6 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all flex items-center gap-2 bg-primary text-primary-foreground hover:bg-primary/90"
                  >
                    {isRtl ? (
                      <>
                        <span>{ctaLabel}</span>
